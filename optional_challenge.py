...
my_pet = f" {pet_name} is {age} and it lives in {pet_home} eats {pet_food[5]}"  # RuntimeError as IndexError: list index out of range,it occurs since we called index 5 which is not in the list
